...
TextTheme _buildTextTheme(TextTheme base, String language) {
  return kTextTheme(base, language)
      .copyWith(
    headline5: base.headline5.copyWith(fontWeight: FontWeight.w500, color: Colors.red),
...
ThemeData buildDarkTheme(String language) {
  ...
  return base.copyWith(
    ...
    buttonTheme: ButtonThemeData(colorScheme: kColorScheme.copyWith(onPrimary: kLightBG)),
    pageTransitionsTheme: const PageTransitionsTheme(builders: {
      TargetPlatform.iOS: FadeUpwardsPageTransitionsBuilder(),
      TargetPlatform.android: FadeUpwardsPageTransitionsBuilder(),
    }),
